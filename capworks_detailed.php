            ...
            <div class="container">
              ...
              <div class="content">
                <?php 
                    if($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'engineer') { ?>
                        <div id="popup" class="center hidden">
                            ...
                            <form class="authform" action="../actions/appoint_worker.php?work=<?php echo $workid; ?>&type=caprepair" method="post">
                                <select name="worker">
                ...
                <?php if($_GET['appointed'] === 'true') { ?>
                    ...
                    <?php } ?>
                <h1>Капитальный ремонт №<?php echo $workid ?></h1>
                <?php
                    $sql = "SELECT * FROM caprepairs WHERE id = $workid";
                    $result = mysqli_query($db, $sql);
                ...
                <?php
                    $sql = "SELECT * FROM appointings WHERE workid = $workid AND type = 'caprepair'";
                    $result = mysqli_query($db, $sql);
